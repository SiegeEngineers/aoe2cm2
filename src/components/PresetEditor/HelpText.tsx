...
const DraftModifiers = () =>
    <>
        <h4>Modifiers</h4>
        <p>A <span className="tag">PARALLEL</span> modifier means both the players to execute their turns in parallel.
            The picks or bans are revealed to the other player and spectators only after both the players have made
            their choices.</p>
        <p>A <span className="tag">HIDDEN</span> modifier hides the civilisation selected during that turn
            from the opponent and from spectators until it is revealed by an admin turn (see below)</p>
    </>;


export const HelpBasics = withTranslation()(Basics);
export const HelpPresetEditor = withTranslation()(PresetEditor);
export const HelpHostAndGuestTurns = withTranslation()(HostAndGuestTurns);
export const HelpAdminTurns = withTranslation()(AdminTurns);
export const HelpPresetModifiers = withTranslation()(PresetModifiers);
export const HelpDraftModifiers = withTranslation()(DraftModifiers);
