...
class Aoe4Map extends DraftOption {
    ...
    public static readonly ALL = [
        new Aoe4Map("Acropolis"),
        new Aoe4Map("African Waters"),
        new Aoe4Map("Alopecia"),
        new Aoe4Map("Altai"),
        ...
        new Aoe4Map("Kawasan"),
        new Aoe4Map("Kerlaugar"),
        new Aoe4Map("King of the Hill"),
        new Aoe4Map("Lakeside"),
        new Aoe4Map("Lipany"),
        ...
        new Aoe4Map("Narrows"),
        new Aoe4Map("Nomadic Ridges"),
        new Aoe4Map("Nomadic Tarns"),
        new Aoe4Map("Oasis"),
        new Aoe4Map("Ocean Gateway"),
        new Aoe4Map("Pigeon Woods"),
        new Aoe4Map("Pigeons Valley"),
        new Aoe4Map("Pigeons View"),
        new Aoe4Map("Prairie"),
        new Aoe4Map("Rain Forest"),
        new Aoe4Map("Receding"),
        new Aoe4Map("Regions"),
